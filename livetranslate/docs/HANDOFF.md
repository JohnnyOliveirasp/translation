...
> **ÚLTIMO ESTADO (22/09/2026, noite):** leia as seções **§22 a §27** — painel da plataforma, Stripe com 2 contas e preços novos, teto de horas + pacotes, deploy por GitHub Actions, /testimonials e Perfil do Google. Pendências que esperam terceiros estão em §23.2, §25 e §26. A memória `livetranslate-handoff` tem o resumo.
